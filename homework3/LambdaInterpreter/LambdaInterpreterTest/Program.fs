...
let data () = 
    [   
        ...
        Application(LambdaAbstraction("x", Variable "y"), Application(LambdaAbstraction("x", Application(Variable "x", Variable "x")), LambdaAbstraction("x", Application(Variable "x", Variable "x")))), Variable "y"
